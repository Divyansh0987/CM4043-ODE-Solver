...
def plotGraph():
    try:
        ...
        assert float(e1[1].get()) >= 0 and float(e2[1].get()) >= 0 and float(e3[1].get()) >= 0 and float(e4[1].get()) >= 0 and float(k1[1].get()) >= 0 and float(k2[1].get()) >= 0 and float(k3[1].get()) >= 0 and float(k4[1].get()) >= 0 and float(k5[1].get()) >= 0
